...
module Engine
  module Game
    class G18SJ < Base
      ...
      MARKET_TEXT = Base::MARKET_TEXT.merge(max_price: '90 or more is required for double jump if double revenue').freeze
