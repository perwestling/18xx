  ...
  module Game
    module G1880RomaniaRegatul
      module Map
        ...
        def map_optional_hexes(option_amira)
          white = {
            # no cities or towns
            ...
            ['O7'] => 'town=revenue:0;city=revenue:0;upgrade=cost:20,terrain:mountain',
            ...
            %w[R2 H8] => 'town=revenue:0;city=revenue:0',
          }
          blue = {
          ...
          red = {
            ...
            ['I7'] => 'city=revenue:yellow_20|green_30|brown_50|gray_70;path=a:0,b:_0,terminal:1;path=a:4,b:_0,terminal:1;path=a:5,b:_0,terminal:1',
          ...
          red[['L6']] = 'city=revenue:yellow_20|green_30|brown_40|gray_50;path=a:0,b:_0,terminal:1;path=a:5,b:_0,terminal:1' if option_amira
          {
              white: white,
              blue: blue,
              red: red,
